    ...
    >
      ...
      <div className="site-nav-right">
        ...
        <span className="site-logo" role="img" aria-label="Max Lux">
          {/* Owner-authored mark v3 (references/maxlux-logo3.svg) embedded
              verbatim; children inherit currentColor so the ink token applies. */}
          <svg viewBox="0 0 248.656 192.867" fill="currentColor" aria-hidden="true" focusable="false">
            ...
            <rect x="9.502" y="79.101" width="223.75" height="8.174"/>
            <rect x="9.502" y="179.89" width="223.75" height="8.174"/>
            <polyline points="81.582 72.959 81.582 72.959 81.582 1.459 61.112 1.459 50.802 25.543 45.573 37.76 45.446 56.06 51.982 56.057 65.175 25.396 65.183 72.955" stroke="currentColor" strokeMiterlimit="10" strokeWidth=".1"/>
            ...
            <polyline points="209.851 138.579 216.137 128.327 233.232 102.828 213.611 102.828 198.461 125.018 183.533 102.828 163.912 102.828 187.248 138.573 187.248 138.579 163.912 174.324 183.533 174.324 198.461 152.134 213.611 174.324 233.232 174.324 216.137 148.825 209.851 138.573"/>
            <polyline points="209.851 37.214 216.137 26.962 233.232 1.464 213.611 1.464 198.461 23.653 183.533 1.464 163.912 1.464 187.248 37.209 187.248 37.214 163.912 72.959 183.533 72.959 198.461 50.77 213.611 72.959 233.232 72.959 216.137 47.46 209.851 37.209"/>
