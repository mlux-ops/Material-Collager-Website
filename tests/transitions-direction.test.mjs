...
test("nav order is the three main routes in progression order", () => {
  assert.deepEqual(NAV_ORDER, ["/", "/generator", "/workbench"]);
});

// Exhaustive 3×3 matrix. Forward = moving right in NAV_ORDER, back = left,
